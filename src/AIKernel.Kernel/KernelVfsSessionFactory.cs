...
/// <summary>[EN] Documents this public package API member. [JA] KernelVfsSessionFactory を表します。</summary>
...
public sealed class KernelVfsSessionFactory : IKernelVfsSessionFactory
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] KernelVfsSessionFactory を実行します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] OpenSessionAsync を取得します。</summary>
