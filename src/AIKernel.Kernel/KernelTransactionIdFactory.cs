...
/// <summary>EN: Documentation for public API. JA: KernelTransactionIdFactory を表します。</summary>
...
public sealed class KernelTransactionIdFactory : IKernelTransactionIdFactory
{
    ...
    /// <summary>EN: Documentation for public API. JA: KernelTransactionIdFactory を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: CreateTransactionId を実行します。</summary>
