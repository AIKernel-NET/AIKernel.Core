...
/// <summary>EN: Documentation for public API. JA: ContextAssemblyGovernanceException を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: ContextAssemblyGovernanceException を実行します。</summary>
