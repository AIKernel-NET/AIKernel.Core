...
/// <summary>EN: Documentation for public API. JA: LogUtil を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: Info を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Warn を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Error を実行します。</summary>
