...
/// <summary>[EN] Documents this public package API member. [JA] PathUtil を表します。</summary>
...
public static class PathUtil
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] Combine を実行します。</summary>
