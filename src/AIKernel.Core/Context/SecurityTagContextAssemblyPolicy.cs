...
/// <summary>EN: Documentation for public API. JA: SecurityTagContextAssemblyPolicy を表します。</summary>
...
public sealed class SecurityTagContextAssemblyPolicy : IContextAssemblyGovernancePolicy
{
    ...
    /// <summary>EN: Documentation for public API. JA: SecurityTagContextAssemblyPolicy を実行します。</summary>
