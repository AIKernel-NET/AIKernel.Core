...
/// <summary>EN: Documentation for public API. JA: FileUtil を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: ReadTextAsync を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: WriteTextAsync を実行します。</summary>
