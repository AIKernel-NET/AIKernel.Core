...
/// <summary>EN: Documentation for public API. JA: StaticModelPromptCapabilityResolver を表します。</summary>
...
public sealed class StaticModelPromptCapabilityResolver : IModelPromptCapabilityResolver
{
    ...
    /// <summary>EN: Documentation for public API. JA: StaticModelPromptCapabilityResolver を実行します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Resolve を取得します。</summary>
