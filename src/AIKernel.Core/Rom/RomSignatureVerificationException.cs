...
/// <summary>EN: Documentation for public API. JA: RomSignatureVerificationException を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: RomSignatureVerificationException を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ExpectedHash を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: ActualHash を取得します。</summary>
