...
/// <summary>EN: Documentation for public API. JA: RomSignatureVerifier を表します。</summary>
...
public sealed class RomSignatureVerifier : IRomSignatureVerifier
{
    ...
    /// <summary>EN: Documentation for public API. JA: RomSignatureVerifier を取得します。</summary>
