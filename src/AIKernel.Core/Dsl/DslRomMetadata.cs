...
internal static class DslRomMetadataKeys
{
    ...
    /// [EN] Documents this public package API member. [JA] RomCall 定数を取得します。
    /// </summary>
    ...
    /// [EN] Documents this public package API member. [JA] RomReplayLogCount 定数を取得します。
    /// </summary>

    public const string RomReplayLogCount = "dsl_rom_replay_log_count";
    /// <summary>
    /// EN: Gets the RomReplayLogHash constant.
    /// [EN] Documents this public package API member. [JA] RomReplayLogHash 定数を取得します。
    /// </summary>
