...
/// <summary>EN: Documentation for public API. JA: UnsupportedPromptCapabilityException を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: UnsupportedPromptCapabilityException を実行します。</summary>
