...
/// <summary>[EN] Documents this public package API member. [JA] AlgorithmTaggedChatTurnSignatureProvider を表します。</summary>
...
{
    /// <summary>[EN] Documents this public package API member. [JA] Algorithm 定数を取得します。</summary>
    ...
    /// <summary>[EN] Documents this public package API member. [JA] SignAsync を取得します。</summary>
