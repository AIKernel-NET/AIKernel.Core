...
/// <summary>[EN] Documents this public package API member. [JA] SemanticStateHash を表します。</summary>
    ...
    string HexDigest)
{
    ...
    /// <summary>[EN] Documents this public package API member. [JA] ToExecutionId を実行します。</summary>
