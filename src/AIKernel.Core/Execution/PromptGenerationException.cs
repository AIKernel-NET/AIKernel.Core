...
/// <summary>EN: Documentation for public API. JA: PromptGenerationException を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: PromptGenerationException を実行します。</summary>
