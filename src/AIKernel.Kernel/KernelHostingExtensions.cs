...
/// <summary>EN: Documentation for public API. JA: KernelHostingExtensions を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: AddAIKernelKernel を取得します。</summary>
