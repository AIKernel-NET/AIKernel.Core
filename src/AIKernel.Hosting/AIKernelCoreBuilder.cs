...
/// <summary>EN: Documentation for public API. JA: AIKernelCoreBuilder を表します。</summary>
...
{
    /// <summary>EN: Documentation for public API. JA: AIKernelCoreBuilder を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Services を取得します。</summary>
    ...
    /// <summary>EN: Documentation for public API. JA: Configuration を取得します。</summary>
